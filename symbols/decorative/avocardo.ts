...
// avocardo symbol from SVG (preserving original path commands)
...
Highcharts.SVGRenderer.prototype.symbols["avocardo"] = function (x: number, y: number, w: number, h: number) {
