...
// building-office symbol from SVG (preserving original path commands)
...
Highcharts.SVGRenderer.prototype.symbols["building-office"] = function (x: number, y: number, w: number, h: number) {
